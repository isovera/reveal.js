...
We created this fork for our own convenience.
There is a small amount of customization: our preferred fonts and an image or
two.
For details, compare the `isovera` branch to the `master` branch:
